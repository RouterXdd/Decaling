...
public class AMWaves {
    public static Seq<SpawnGroup> generate(float difficulty, Rand rand, boolean attack) {
        UnitType[][] species = {
                ...
                {retor, retor, retor, retor, retor},
                {apparition, apparition, apparition, apparition, shadow}
        };
        ...
        float shieldStart = 30, shieldsPerWave = 20 + difficulty*35f;
