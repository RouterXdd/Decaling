...
public class PowerMultiTurret extends BaseTurret{
    ...
    public PowerMultiTurret(String name){
        super(name);
    ...
    public void init(){
        ...
        unitType = new UnitType("turret-unit-" + name){{
            ...
            health = 1;
            itemCapacity = 0;
            rotateSpeed = PowerMultiTurret.this.rotateSpeed;
            buildBeamOffset = PowerMultiTurret.this.buildBeamOffset;
            buildRange = PowerMultiTurret.this.range;
            buildSpeed = PowerMultiTurret.this.buildSpeed;
            constructor = BlockUnitUnit::create;
            weapons = PowerMultiTurret.this.unitType.weapons;
        }};
    }
    ...
    public class PowerMultiTurretBuild extends BaseTurretBuild implements ControlBlock{
