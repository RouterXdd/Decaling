...
public class RotateDrill extends Block{
    ...
    public RotateDrill(String name){
        super(name);
        update = true;
        solid = true;
        hasLiquids = true;
    ...
    public void setBars(){
        ...
        addBar("drillspeed", (RotateDrill.RotateDrillBuild e) ->
    ...
    public class RotateDrillBuild extends Building {
