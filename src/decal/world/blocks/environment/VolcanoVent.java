package decal.world.blocks.environment;
...
public class VolcanoVent extends Floor {
    ...
    public Effect effect = DecalingFx.volcanoVent;
    public Color effectColor = DecalPal.volcanoBlueColor;
    ...
    public VolcanoVent(String name){
        super(name);
        variants = 1;
    }
